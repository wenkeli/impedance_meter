...
# need to add it here.
#PROJECT_INCLUDE_DIRS := UTFTGUIIncludes/
...
cppSRCS_$(d) := textdisplay.cpp
cppSRCS_$(d) += baseaction.cpp
cppSRCS_$(d) += basepage.cpp
cppSRCS_$(d) += button.cpp
cppSRCS_$(d) += rectangle.cpp
