...
EXTERNAL_INCLUDE_DIRS := $(d)/../UTFT/ 
EXTERNAL_INCLUDE_DIRS += $(d)/../UTouch/
EXTERNAL_INCLUDE_DIRS += $(d)/../UTFT_GUI/
...
cppSRCS_$(d) := src/real-main.cpp
cppSRCS_$(d) += src/channelmap.cpp
cppSRCS_$(d) += src/currentsrc.cpp
cppSRCS_$(d) += src/impedancemeasure.cpp
cppSRCS_$(d) += src/hardware.cpp
cppSRCS_$(d) += src/actiontypes.cpp
cppSRCS_$(d) += src/pagetypes.cpp
